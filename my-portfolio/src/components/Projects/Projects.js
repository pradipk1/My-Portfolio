...
import './projects.css'
import ecart_pic from '../../images/ecart_pic.png'
      ...
      <div className='projects-desc-div'>
        ...
        <div className='projects-card-div'>
          <div className='projects-img-div'>
            <img src={ecart_pic} alt='dominoz pic'/>
          </div>
          <div className='project-desc'>
            <h2 style={{marginBottom:'20px'}} className='colored-span-tag'>E-Cart Website</h2>
            <p style={{marginBottom:'20px', fontSize:'18px'}}>
              This is a dummy E-Cart website for practice purpose only. This is a frontend project. In this website, 
              user can create account, can filter the products, can add products to cart and can place the order.
            </p>
            <p style={{marginBottom:'20px', fontSize:'18px'}}><span className='colored-span-tag'>Tech Stacks:</span>  HTML | CSS | JavaScript | React | Redux</p>
            <div className='projects-link'>
              <Link className='projects-git-link' to='https://github.com/pradipk1/ECOMMERCE-1' target='_blank'>
              ...
              <Link className='projects-git-link' to='https://frontend-practice-ecart-website.netlify.app/' target='_blank'>
